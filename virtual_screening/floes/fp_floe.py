...
from cubes.compute_cubes import (AccuMolList, PrepareRanking, ParallelTreeFPRanking, ParallelPathFPRanking, ParallelCircularFPRanking, ParallelFastROCSRanking,
                                ParallelTreeFPInsertKA, ParallelPathFPInsertKA, ParallelCircularFPInsertKA, ParallelInsertKARestfulROCS, AccumulateRankingsFP, AnalyseRankings, IndexGenerator)
...
#
## Add Cubes to Floe
job.add_cubes(act_reader, index_reader, accu_act, prep_ranking, create_treeFPranking, create_pathFPranking, create_circularFPranking, 
              insert_treeFPka, insert_pathFPka, insert_circularFPka, accu_rankings, analyse_rankings, results_output, plot_results, write_ranking)
