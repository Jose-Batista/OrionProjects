...
from cubes.compute_cubes import (AccuMolList, PrepareRanking, ParallelTreeFPRanking, ParallelPathFPRanking, ParallelCircularFPRanking, ParallelFastROCSRanking,
                                ParallelTreeFPInsertKA, ParallelPathFPInsertKA, ParallelCircularFPInsertKA, ParallelInsertKARestfulROCS, AccumulateRankingsTree, AnalyseRankings, IndexGenerator)
...
accu_rankings = AccumulateRankingsTree('accumulate rankings')
...
#
## Add Cubes to Floe
job.add_cubes(act_reader, index_generator, accu_act, prep_ranking, create_treeFPranking, 
              insert_treeFPka, accu_rankings, analyse_rankings, results_output, plot_results, write_ranking)
